        ...
        <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/90 backdrop-blur-sm p-4 animate-in fade-in duration-300">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden relative">
                ...
                <div className="bg-stone-900 text-white p-6 text-center">
                    ...
                    <p className="text-stone-400 text-sm mt-1">Please enter your opening fund / petty cash.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="p-8 space-y-6">
                    <div className="space-y-4">
                        <div>
                            <label className="block text-xs font-bold uppercase text-stone-500 mb-1">Opening Amount</label>
                        ...
                        <div>
                            <label className="block text-xs font-bold uppercase text-stone-500 mb-1">Counted By</label>
                            <div className="relative">
