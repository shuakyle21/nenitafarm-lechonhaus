...
vi.mock('@react-pdf/renderer', () => ({
    ...
    Text: ({ children, style }: any) => <div data-testid="text" style={Array.isArray(style) ? Object.assign({}, ...style) : style}>{children}</div>,
    View: ({ children, style }: any) => <div data-testid="view" style={Array.isArray(style) ? Object.assign({}, ...style) : style}>{children}</div>,
