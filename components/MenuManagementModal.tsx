                    ...
                    >
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2">
                          ...
                          {item.isWeighted && (
                            <span className="text-[10px] font-bold bg-yellow-100 text-yellow-800 px-2 py-0.5 rounded uppercase">Weighted</span>
                          )}
                        </div>
                      ...
                      <div className="text-right mr-4">
                        <div className="font-bold text-stone-800">₱{item.price.toLocaleString('en-PH', { minimumFractionDigits: 2 })}</div>
              ...
              <form onSubmit={handleSubmit} className="max-w-2xl mx-auto space-y-6">
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="col-span-2">
                    <label className="block text-sm font-bold text-stone-600 mb-2 uppercase text-xs tracking-wider">Item Name</label>
                    <input
                      type="text"
                      required
                      value={formData.name}
                  ...
                  <div>
                    <label className="block text-sm font-bold text-stone-600 mb-2 uppercase text-xs tracking-wider">Price (₱)</label>
                    <input
                      type="number"
                      required
                      min="0"
                  ...
                  <div>
                    <label className="block text-sm font-bold text-stone-600 mb-2 uppercase text-xs tracking-wider">Category</label>
                    <select
                  ...
                  <div className="col-span-2">
                    <label className="block text-sm font-bold text-stone-600 mb-2 uppercase text-xs tracking-wider">Image URL</label>
                    <div className="flex gap-4">
                      <div className="flex-1 relative">
                        <Image className="absolute left-3 top-1/2 -translate-y-1/2 text-stone-400" size={20} />
                        <input
                          type="text"
                        ...
                        <div className="absolute right-2 top-1/2 -translate-y-1/2">
                          <label className={`flex items-center gap-2 px-3 py-1.5 rounded-lg cursor-pointer transition-colors ${uploading ? 'bg-stone-100 text-stone-400 cursor-not-allowed' : 'bg-stone-900 text-white hover:bg-stone-700'}`}>
                            <Upload size={14} />
                  ...
                  <div className="col-span-2">
                    <label className="flex items-center gap-3 p-4 bg-white border border-stone-300 rounded-xl cursor-pointer hover:border-stone-400 transition-colors">
                      ...
                      <div>
                        ...
                        <span className="text-xs text-stone-500">Price is calculated per kilogram (e.g. Lechon)</span>
                      </div>
                    </label>
                  </div>
