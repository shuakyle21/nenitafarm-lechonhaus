...
*(Note: We skipped Staging because of the 2-project limit on the Free Tier)*
...
- **Data vs Schema.** These steps sync the *structure* (tables, columns). Data (rows) usually doesn't need to be synced unless it's "reference data" (like a list of categories).
