...
const BookingReceiptPDF: React.FC<BookingReceiptPDFProps> = ({ booking }) => {
    return (
        <Document>
            <Page size="A6" style={styles.page}> {/* A6 is good for receipts */}
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.row}>
                        ...
                        <Text style={styles.value}>{format(parseISO(booking.booking_date), 'MMM d, yyyy')} @ {booking.booking_time}</Text>
                    </View>
                </View>
                    ...
                    <View style={styles.section}>
                        ...
                        {booking.items.map((item, index) => (
                            <View key={index} style={styles.itemRow}>
                                <Text style={[styles.value, { width: '60%' }]}>{item.quantity}x {item.name}</Text>
