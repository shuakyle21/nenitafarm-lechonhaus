      ...
      <div className="bg-white rounded-2xl shadow-2xl w-[500px] overflow-hidden flex flex-col animate-in zoom-in-95 duration-200">
        ...
        <div className="p-6 flex-1 bg-stone-50">
          ...
          <div className="flex gap-4 mb-6">
            <button
              onClick={() => { setMode('weight'); setInputValue('0'); }}
              className={`flex-1 flex flex-col items-center justify-center p-4 rounded-xl border-2 transition-all ${mode === 'weight'
            ...
            <button
              onClick={() => { setMode('price'); setInputValue('0'); }}
              className={`flex-1 flex flex-col items-center justify-center p-4 rounded-xl border-2 transition-all ${mode === 'price'
          ...
          <div className="bg-white border border-stone-200 rounded-xl p-4 mb-6 flex justify-between items-center shadow-sm">
            <div>
              <div className="text-xs text-stone-500 font-bold uppercase tracking-wider">Estimated Weight</div>
              <div className="text-2xl font-bold text-stone-800">{displayWeight.toFixed(3)} kg</div>
            </div>
            <div className="text-right">
              <div className="text-xs text-stone-500 font-bold uppercase tracking-wider">Total Price</div>
              <div className="text-3xl font-brand font-black text-red-700">₱{displayPrice.toLocaleString('en-PH', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
            </div>
          </div>
