            ...
            <div className="w-full max-w-[480px] bg-white rounded-3xl shadow-2xl overflow-hidden relative z-10 animate-in zoom-in-95 duration-500">
                ...
                <div className="relative bg-red-800 pt-12 pb-16 px-8 text-center">
                    ...
                    <div className="relative z-10 flex flex-col items-center">
                        ...
                        <h1 className="text-3xl font-black text-white uppercase tracking-wider drop-shadow-md font-serif">Nenita Farm</h1>
                        <div className="flex items-center gap-3 mt-2">
                            <span className="h-0.5 w-8 bg-gradient-to-r from-transparent to-yellow-400"></span>
                            <p className="text-yellow-400 font-bold text-xl font-cursive italic tracking-wide">Lechon Haus</p>
                    ...
                    <div className="absolute bottom-2 left-0 right-0 h-1 bg-gradient-to-r from-yellow-600 via-yellow-300 to-yellow-600 opacity-80" style={{ clipPath: 'ellipse(60% 100% at 50% 100%)' }}></div>
                </div>

                {/* Form Section */}
                <div className="px-10 pb-10 pt-6">
                    <div className="text-center mb-8">
                        <p className="text-stone-500 text-sm font-medium uppercase tracking-widest">System Access</p>
                    </div>
