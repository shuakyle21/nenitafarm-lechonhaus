...
const ExpenseModal: React.FC<ExpenseModalProps> = ({ 
    ...
    amount, setAmount, reason, setReason, person, setPerson 
}) => {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 animate-in fade-in duration-200">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden relative">
                <div className="bg-red-600 text-white p-6 text-center">
                   ...
                   <p className="text-red-100 text-xs mt-1">Deduct from cash drawer</p>
                </div>
                ...
                <form onSubmit={onSubmit} className="p-6 space-y-4">
                    <div>
                     ...
                     <div>
                        ...
                        <input
                            ...
                            placeholder="e.g. Supplies, Gas"
                        />
                    </div>
                     <div>
                        <label className="block text-xs font-bold uppercase text-stone-500 mb-1">Requested By</label>
                        <div className="relative">
                    ...
                    <div className="flex gap-3 pt-2">
                        ...
                        >
                            {isLoading ? 'Saving...' : 'CONFIRM EXPENSE'}
                        </button>
                    </div>
                </form>
            </div>
