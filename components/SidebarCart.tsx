      ...
      <div className="bg-red-900 text-white p-4 shadow-md bg-[url('https://www.transparenttextures.com/patterns/cubes.png')]">
        ...
        <div className="flex bg-red-800/50 p-1 rounded-lg mt-2 mb-2">
          <button
            ...
            className={`flex-1 flex items-center justify-center gap-1 py-1.5 rounded-md text-xs font-bold transition-all ${orderType === 'DINE_IN'
          ...
          <button
            ...
            className={`flex-1 flex items-center justify-center gap-1 py-1.5 rounded-md text-xs font-bold transition-all ${orderType === 'TAKEOUT'
              ? 'bg-white text-red-900 shadow-sm'
              : 'text-red-200 hover:bg-red-800'
              }`}
          >
        ...
        <div className="relative mt-1">
          ...
          >
            Server: <span className="font-bold underline decoration-dotted">{selectedServer ? selectedServer.name : 'Select Server'}</span>
            <ChevronDown size={12} />
          </button>
            ...
            >
              <div className="flex justify-between items-start">
                ...
                <div className="text-right">
                  <div className="font-bold text-red-700">₱{item.finalPrice.toLocaleString('en-PH', { minimumFractionDigits: 2 })}</div>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between mt-2 pt-2 border-t border-stone-100">
                ...
                {!item.isWeighted ? (
                  ...
                  <span className="text-xs font-bold text-stone-400 uppercase tracking-wider">Weighted Item</span>
                )}
      ...
      <div className="bg-white p-4 border-t border-stone-200 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
        <div className="space-y-2 mb-4">
          ...
          {discount ? (
            <div className="flex justify-between text-red-600 text-sm font-medium">
              <div className="flex flex-col">
                <span className="flex items-center gap-1"><Tag size={12} /> {discount.type} (20%)</span>
          ...
          <div className="flex justify-between text-stone-800 text-xl font-bold pt-2 border-t border-dashed border-stone-200">
            <span>Total</span>
            <span className="font-brand text-2xl">₱{total.toLocaleString('en-PH', { minimumFractionDigits: 2 })}</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 mb-3">
          <button
            ...
            className={`py-3 px-4 rounded-xl border-2 font-bold transition-colors flex items-center justify-center gap-2 ${discount
