      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableRow}>
            ...
            <View style={styles.tableCol}>
              <Text style={[styles.tableCell, styles.textRight]}>
                P {reportExpenses.toLocaleString()}
              </Text>
            </View>
          </View>
          <View style={styles.tableRow}>
            ...
            <View style={styles.table}>
              ...
              {salesAdjustments.map((s, i) => (
                <View key={i} style={styles.tableRow}>
                  ...
                  <View style={{ ...styles.tableCol, width: '15%' }}>
                    <Text style={[styles.tableCell, styles.textRight, styles.textGreen]}>
            ...
            <View style={[styles.table, { borderTopWidth: 0, marginTop: -1 }]}>
              <View style={styles.tableRow}>
                <View style={{ ...styles.tableCol, width: '85%', borderRightWidth: 0 }}>
                  <Text style={[styles.tableCell, styles.textRight, { fontWeight: 'bold' }]}>
                    TOTAL SALES ADJUSTMENT
                  </Text>
                </View>
                <View style={{ ...styles.tableCol, width: '15%' }}>
                  <Text
                  ...
                  >
                    P {adjustmentsTotal.toLocaleString()}
                  </Text>
                </View>
              </View>
            </View>
            ...
            <View style={styles.table}>
              ...
              {expenses.map((e, i) => (
                <View key={i} style={styles.tableRow}>
                  ...
                  <View style={{ ...styles.tableCol, width: '15%' }}>
                    <Text style={[styles.tableCell, styles.textRight, styles.textRed]}>
                      P {e.amount.toLocaleString()}
                    </Text>
                  </View>
                </View>
              ))}
