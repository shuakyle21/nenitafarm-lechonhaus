...
const MobileBottomNav: React.FC<MobileBottomNavProps> = ({
  ...
  return (
    <>
      ...
      {/* More Drawer Panel */}
      <div 
        className={`fixed left-0 right-0 z-[45] bg-stone-950 border-t border-stone-800 lg:hidden transition-transform duration-300 ease-out shadow-[0_-8px_30px_rgba(0,0,0,0.6)] flex flex-col items-center py-4 px-2 space-y-4 rounded-t-3xl ${isMoreMenuOpen ? 'translate-y-0' : 'translate-y-full'}`}
